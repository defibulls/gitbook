...
We are setting ourselves up to mine Bitcoin until the very last day possible. Each BTC Bull be working on the ranch until that day happens in the year 2040. At this point, each BTC Bull will eventually lose its mission of mining BTC. As with all things done on The Ranch, we can always pivot and find another use case for the Bulls. They are beloved in our community and will not be abandoned. &#x20;
